      ...
      bottomNavigationBar: BottomNavigationBar(
        items: const <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              icon: Image(
                  image:
                      AssetImage("assets/image/tabicon/home_tab_class_n.png"),
                  width: 50,
                  height: 50),
              label: (""),
              activeIcon: Image(
                  image:
                      AssetImage("assets/image/tabicon/home_tab_class_s.png"),
                  width: 50,
                  height: 50)),
          BottomNavigationBarItem(
              icon: Image(
                  image:
                      AssetImage("assets/image/tabicon/home_tab_study_n.png"),
                  width: 50,
                  height: 50),
              label: (""),
              activeIcon: Image(
                  image:
                      AssetImage("assets/image/tabicon/home_tab_study_s.png"),
                  width: 50,
                  height: 50)),
          BottomNavigationBarItem(
              icon: Image(
                  image: AssetImage("assets/image/tabicon/home_tab_me_n.png"),
                  width: 50,
                  height: 50),
              label: (""),
              activeIcon: Image(
                  image: AssetImage("assets/image/tabicon/home_tab_me_s.png"),
                  width: 50,
                  height: 50))
        ],
        onTap: _tapTab,
